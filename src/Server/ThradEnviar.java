...
boton.setIcon(new ImageIcon(getClass().getResource("/imagenes/Cruz.png")));
            boton.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/Cruz.png")));
    ...
    public ThradEnviar(Ventana ventana, Socket conexion) {
        ...
        try {
            for (int i = 1; i < 10; i++) {
                Class clase = Class.forName("Server.Ventana");
